  ...
  return (
    <div className={cn("relative", items.length === 0 && "hidden", className)}>
      <div
        ...
        className={cn(
          "flex gap-4 sm:gap-6 overflow-x-auto scrollbar-none snap-x snap-mandatory scroll-smooth select-none py-1",
      ...
      >
        {items.map((item, index) => (
          <div
            ...
            className={cn(
              "shrink-0 snap-start w-[74%] min-[480px]:w-[46%] md:w-[31%] lg:w-[30%] xl:w-[23.5%] min-w-[220px]",
              itemClassName
            )}
          >
