...
export const DashboardHeader: React.FC<DashboardHeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-black/10 dark:border-white/15 bg-white/75 dark:bg-black/60 backdrop-blur-xl px-3 py-3 flex flex-col flex-nowrap">
