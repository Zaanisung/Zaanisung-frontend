    ...
    <div className="relative px-4 sm:px-8 xl:px-12 py-4 flex items-center justify-between gap-2 flex-nowrap">
      ...
      <div className="flex items-center gap-2 flex-shrink-0 ml-auto">
        <button
          type="button"
          onClick={onOpenCart}
          className="relative min-h-[44px] min-w-[44px] rounded-lg p-2 flex items-center justify-center text-ink/60 dark:text-white/60 bg-cream dark:bg-white/[0.06] border border-black/10 dark:border-white/15 hover:scale-[1.05] active:scale-[0.98] transition-all duration-[400ms] ease-[cubic-bezier(0.25,0.46,0.45,0.94)]"
