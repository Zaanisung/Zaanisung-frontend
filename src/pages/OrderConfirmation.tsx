...
export const OrderConfirmation: React.FC<OrderConfirmationProps> = ({
  ...
  return (
    <div className="w-full max-w-lg mx-auto py-6 px-4">
      <div className="relative overflow-hidden surface-glass-strong rounded-2xl kente-frame p-6 sm:p-10 shadow-[0_0_0_1px_rgba(212,175,55,0.1),0_12px_40px_-10px_rgba(0,0,0,0.15)] text-center">
